...
☁️ Google Drive | Rclone Cloud | Telegram | DDL Servers.</i>\n
Type {help_command} to get a list of available commands</b>'''
    ST_BOTPM = '''<i>Now, This bot will send all your files and links here. Start Using ...</i>'''
    ST_UNAUTH = '''<i>You Are not authorized user! Deploy your own RDXMOVIE Mirror-Leech bot</i>'''
...
<i>📌 When enabled, leech uploads get auto-styled captions with title, IMDB rating, quality, audio & size.</i>'''
    ...
    AI_CAPTION_ENABLED_MSG  = '✅ AI Caption <b>Enabled!</b> Stylish captions will be auto-generated for leech uploads.'
    AI_CAPTION_DISABLED_MSG = '❌ AI Caption <b>Disabled!</b> Standard filename captions will be used.'
    AI_CAPTION_IMDB_ON  = '✅ IMDB Lookup <b>Enabled!</b> Ratings & genres will be fetched from IMDB.'
    AI_CAPTION_IMDB_OFF = '❌ IMDB Lookup <b>Disabled!</b> Only filename metadata will be used.'
    AI_CAPTION_TEMPLATE_SET = '✅ AI Caption Template <b>Updated!</b>\n<code>{template}</code>'
    AI_CAPTION_TEMPLATE_RESET = '🔄 AI Caption Template <b>Reset</b> to default.'
    AI_CAPTION_TEMPLATE_HELP = '''<b>🤖 AI Caption Template Help</b>

Set a custom caption template using these variables:
...
<code>🎬 {title}{year_str}\n\n{imdb_line}🎞 Quality: {quality}\n🔊 Audio: {languages}\n📦 Size: {file_size}{season_ep_line}{genre_line}</code>

Send <code>reset</code> to restore the default template.'''
