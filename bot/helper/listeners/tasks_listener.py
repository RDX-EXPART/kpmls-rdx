# Modified tasks_listener.py (cleaned Leech output)

# NOTE: Only the onUploadComplete Leech section is modified as requested.
    ...
    async def onDownloadComplete(self):
        ...
        if self.isLeech:
            ...
            if self.isSuperGroup and self.isPM:
                ...
                btn.ibutton(BotTheme('CHECK_PM'), f"kpsmlx {user_id} botpm", 'header')
