...
<b>Personalization:</b>
┠ /{BotCommands.MyThemeCommand}: Customize your progress bar, emoji pack & button style.
┖ /{BotCommands.MyLevelCommand}: View your XP, level, VIP badge & leaderboard.''',
...
<b>Night Mode:</b>
┖ /{BotCommands.NightModeCommand}: Configure time-based speed throttling (Owner & Sudo).''',
...
default_desp = {'AS_DOCUMENT': 'Default type of Telegram file upload. Default is False mean as media.',
                ...
                'AI_CAPTION': 'Enable AI Caption Generator for leech uploads. When True, auto-generates stylish captions with title, IMDB rating, quality, audio & file size. Default is False. Bool',
                'AI_CAPTION_IMDB': 'Enable IMDB lookup in AI Caption. When True, fetches movie/series rating & genres from IMDB using cinemagoer. Default is True. Bool',
                'AI_CAPTION_TEMPLATE': 'Custom template for AI Caption. Use {title}, {year_str}, {imdb_line}, {quality}, {languages}, {file_size}, {season_ep_line}, {genre_line} etc. Leave empty for default template. Str',
