#!/usr/bin/env python3
"""
Modified bot_commands.py — adds three new commands for the new features:
  MyThemeCommand   → /mytheme
  MyLevelCommand   → /mylevel
  NightModeCommand → /nightmode  (owner-only)
"""
...
class _BotCommands:
    def __init__(self):
        ...
        # Feature 1: User Custom Themes
        self.MyThemeCommand = f'mytheme{CMD_SUFFIX}'

        # Feature 2: User Level System
        self.MyLevelCommand = f'mylevel{CMD_SUFFIX}'

        # Feature 3: Night Mode (owner/sudo only)
