...
def build_preview_message(style_key: str, pack_key: str, caption_key: str, button_style: str = 'default') -> str:
    ...
    btn_style = BUTTON_STYLES.get(button_style, BUTTON_STYLES['default'])
    return (
...
async def mytheme_callback(client, query):
    ...
    if action == 'section':
        ...
        if section == 'progress':
            ...
            preview = build_preview_message(cfg['progress_style'], cfg['emoji_pack'], cfg['caption_style'], cfg.get('button_style', 'default'))
