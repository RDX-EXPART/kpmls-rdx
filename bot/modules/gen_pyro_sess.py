...
async def get_decrypt_key(client, message):
    ...
    if message.chat.type != ChatType.PRIVATE:
        ...
        grp_prompt = await sendMessage(message, "<i>User Session (Pyrogram V2 Session) Access of your Account is needed for Message to Access, it can't be Accessed by Bot and Session</i>", btn.build(1))
