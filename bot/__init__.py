...
AI_CAPTION = environ.get('AI_CAPTION', '')
AI_CAPTION = AI_CAPTION.lower() == 'true'

AI_CAPTION_IMDB = environ.get('AI_CAPTION_IMDB', 'true')
AI_CAPTION_IMDB = AI_CAPTION_IMDB.lower() == 'true'

AI_CAPTION_TEMPLATE = environ.get('AI_CAPTION_TEMPLATE', '')
...
config_dict = {'ANIME_TEMPLATE': ANIME_TEMPLATE,
               ...
               'AI_CAPTION_IMDB': AI_CAPTION_IMDB,
               'AI_CAPTION_TEMPLATE': AI_CAPTION_TEMPLATE,
               'SAFE_MODE': SAFE_MODE,
